    ...
    const profile1Messages = [
        ...
        { type: 'image', imgUrl: "res/test/pic.png", imgDesc: "smile", options: ["Thanks"], paths: [12, 12], adult: false }, // 8
        ...
        { type: 'image', imgUrl: "https://media.tenor.com/GSUqW6Z4gQAAAAAM/funny-video-comedy.gif", imgDesc: "test sent gif", options: ["nice response", "mean response"], optionsBig: ["I love your personality. Keep acting that way","Just come to the point. What do you want?"], paths: [20,21], adult: false}, // 19
        { type: 'text', text: "I like you too. Anyway..."}, // 20
        { type: 'video', imgUrl: "res/vid/testREDGIF.mp4", imgDesc: "test video", options: [], paths: [],adult: true}, // 21
