const profile2Messages = [
    ...
    { type: 'image', imgUrl: "res/2prof/pfp.jpg", options: ["My name's Joe", "..."], paths: [8, 5] },
    { type: 'text', text: "Come on, do you need help?", options: ["Fuck off", "Yes!"], paths: [10, 6] },  
    { type: 'text', text: "Will you tell me you're name after this", options: [], paths: [] },  
    { type: 'image', imgUrl: "res/2prof/help.jpg", options: ["Okay, it's Joe"], paths: [8] },
