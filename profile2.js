const profile2Messages = [
    ...
    { type: 'image', imgUrl: "res/2prof/pfp.jpg", imgDesc: "Ava smiling", options: ["My name's " + localStorage.getItem("name_"), "..."], paths: [9, 6], adult: false },
    ...
    { type: 'image', imgUrl: "res/2prof/help.jpg", imgDesc: "Ava trying to help you", adult: true, options: ["Okay, it's " + localStorage.getItem("name_")], paths: [9] },
